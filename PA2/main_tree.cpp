...
int main(void)
{
  ...
  std::cout << "Inserting 8 again" << std::endl;
  list_bst.insert(8, 9);
  list_bst.print(std::cout);
  std::cout << std::endl;
  ...
  std::cout << "Inserting so many things" << std::endl;
  list_bst.insert(-1,-1);
  list_bst.insert(-2,-2);
  list_bst.insert(-3,-3);
  list_bst.insert(-4,-4);
  ...
  list_bst.print(std::cout);
  std::cout << std::endl;
 std::cout << "Search elements within [2, 9]..." << std::endl;
  std::list<BinarySearchTree<int, float, AdditionalBalance>::Node *> results = list_bst.find(2, 9);

  std::cout << "Results: " <<std::endl;
  for (std::list<BinarySearchTree<int, float,AdditionalBalance>::Node *>::const_iterator itr = results.begin();
      itr != results.end(); ++itr)
  {
